    ...
    <div class="left-side">
        <div class="item-holder" style="direction: rtl; padding: 7px;">
            <p style="font-family: Titr; font-size: 27px; text-align: center;">
                چرا باید درگاه فیلم ایران را جهت پخش و ارسال فیلم و فیلمنامه‌تان انتخاب کنید؟
            </p>
            <p style="color: red;">
            ...
            <p>
                ملاک از نگارش شاخص‌های زیر تنها بیان ویژگی های درگاه فیلم ایران نیست، بلکه راه و
                                رسمی است که به شما کمک خواهد کرد، یک پخش کننده حقیقی را از غیر حقیقی تشخیص دهید.
            </p>
            <div class="item" style="text-align: center;">
                ...
                <h6>Head of Distribution Company | مدیریت پخش یک شرکت پخش</h6>
                <p>
            ...
            <div class="item" style="text-align: center;">
                ...
                <h6>Legal | حقوقی بودن پخش کننده</h6>
                <p>
            ...
            <div class="item" style="text-align: center;">
                ...
                <h6>International Relations | روابط بین المللی پخش کننده</h6>
                <p>
            ...
            <div class="item" style="text-align: center;">
                ...
                <h6>Expertise & Focus on broadcasting | تخصص و تمرکز بروی پخش فیلم و فیلمنامه</h6>
                <p>
            ...
            <div class="item" style="text-align: center;">
                ...
                <p>
                    ...
                    درگاه فیلم ایران با دارا بودن وب سایتی رسمی و پویا و همچنین پیچ و اینستاگرامی که
                                    ...
                                    <br />
                    <p>
                        <a href="مشتریان-درگاه-فیلم-ایران" style="color: Blue; font-size: 14px;" target="_blank">لیست مشتریان درگاه فیلم ایران</a>
                    </p>
                    <p>
            ...
            <div class="item" style="text-align: center;">
                ...
                <h6>Dedicated Portal | پرتال اختصاصی فیلمسازان و فیلمنامه نویسان</h6>
                <p>
                ...
                <p>
                    <a href="files/images/icons/Samaneh.png" style="color: Blue; font-size: 14px;" target="_blank">تصویری از سامانه اختصاصی</a>
                </p>
            </div>
            <hr />
            <div class="item" style="text-align: center;">
                ...
                <h6>Instant Access | دردسترس بودن فوری</h6>
                <p>
                ...
                <p>
                    <a href="مشاوره-پخش-بین-المللی-فیلم" style="color: Blue; font-size: 14px;" target="_blank">جهت آشنایی با فرآیند مشاوره درگاه فیلم ایران کلیک کنید</a>
                </p>
            </div>
            <hr />
            <div class="item" style="text-align: center;">
                ...
                <h6>Free Consultion | مشاوره رایگان</h6>
                <p>
            ...
            <div class="item" style="text-align: center;">
                ...
                <p>
                    یکی از بزرگترین ضعف های پخش کننده نماهای فعال! عدم سازوکار حقوقی و قانونی است. در
                                    ...
                                    فیلم قرار خواهد گرفت و در مرحله دوم در صورت تمایل افراد بصورت پستی ارسال خواهد شد.
                </p>
                <p>
                    «درگاه فیلم ایران» بصورت آژانسی وابسته ذیل شرکت تصویرسازان عصر گرانش فعالیت کرده
                                    و اعتبار حقوقی خود را از آن شرکت می‌گیرد.
                </p>
            </div>
            <hr />
            <div class="item" style="text-align: center;">
                ...
                <p>
                    <a target="_blank" href="رسانه-سازی-پخش-فیلم" style="color: Blue; font-size: 14px;"
                        target="_blank">جهت کسب اطلاعات بیشتر به بخش «رسانه سازی - Media-Making» کلیک کنید</a>
                </p>
            </div>
            <hr />
            <div class="item" style="text-align: center;">
                ...
                <h6>Categorization | طبقه بندی</h6>
                <p>
                    یکی دیگر از بزرگترین ضعف های پخش کننده نماها! و حتی پلتفرم ها، عدم توانایی در تفکیک
                                    ...
                                    می شود پوشش و تفکیک تمامی آنها نیز غیر منطقی است.
                </p>
                <p>
                    درگاه فیلم ایران (IFP) فستیوال ها را در چهار دسته ی A+ A B C دسته بندی خواهد کرد.
                </p>
            </div>
            <%--                                <div class="item" style="text-align:center;">
								<div class="icon-box">
            ...
            <div class="item" style="text-align: center;">
                ...
                <h6>Interaction | ارتباط دو طرفه</h6>
                <p>
                    کارشناسان ارتباط با مشتری (CRM) و روابط عمومی درگاه فیلم ایران به طور دائمی و بیست
                                    ...
                                    خدمات خود را اطلاعات رسانی می‌کند.
                </p>
            </div>
            <hr />
            <div class="item" style="text-align: center;">
                ...
                <h6>Strategic Plan | پلن استراتژیک</h6>
                <p>
                    درگاه فیلم ایران پس از عقد قرارداد رسمی برای هر فیلم و یا فیلمنامه استراتژی پخش
                                    ...
                                    جداگانه و خارج از قرارداد نیز قابل تهیه می باشد.
                </p>
                <p>
                    «درگاه فیلم ایران» با دارا بودن تیمی مجرب و حرفه ای در حوزه <a target="_blank" href="http://iranfilmport.com/%D9%BE%D8%AE%D8%B4-%D9%88-%D8%A7%D8%B1%D8%B3%D8%A7%D9%84-%D9%81%DB%8C%D9%84%D9%85">پخش و ارسال فیلم به فستیوال های بین المللیِ فیلم و فیلمنامه</a> در تمامی ژانرهای
                ...
                <p>
                    «پِلن استراتژیک پخش» و یا برنامه ی مدون شده ی چگونگی ارسال فیلم به جشنواره های خارجی،
                                    ...
                                    A+ (اسکاری) و A (قدمت بالای 20 سال) در جهان حدود 700 فستیوال است!
                </p>
                <p>
                    <a target="_blank" href="http://iranfilmport.com/%D8%A8%D8%B1%D9%86%D8%A7%D9%85%D9%87-%D8%A7%D8%B3%D8%AA%D8%B1%D8%A7%D8%AA%DA%98%DB%8C%DA%A9-%D9%BE%D8%AE%D8%B4-%D9%81%DB%8C%D9%84%D9%85-%D8%A8%D9%87-%D8%AC%D8%B4%D9%86%D9%88%D8%A7%D8%B1%D9%87-%D9%87%D8%A7%DB%8C-%D8%AE%D8%A7%D8%B1%D8%AC%DB%8C">جهت مشاهده توضیحات بیشتر در خصوص پلن و یا برنامه استراتژیک کلیک کنید.</a>
                </p>
            </div>
            <hr />
            <div class="item" style="text-align: center;">
                ...
                <h6>Receipt | رسید تحویل هر ارسال</h6>
                <p>
                    یکی از اصلی ترین اقدامات درگاه فیلم ایران، اعتماد سازی لحظه به لحظه و آسوده سازی
                                    ...
                                    از طرق مختلف همچون ایمیل و یا اسکرین شات به مشتریان تحویل داده خواهد شد.
                </p>
                <p>
                    <a href="http://iranfilmport.com/files/images/resource/receipt.jpg" target="_blank">(جهت دانلود نمونه‌ای از رسید کلیک کنید)</a>
                </p>
            </div>
            <hr />
            <div class="item" style="text-align: center;">
                ...
                <h6>Performance Report | گزارش عملکرد</h6>
                <p>
                    درگاه فیلم ایران به جهت احترام به مشتری و روشن سازی فرآیند پخش و ارسال آثار در مدت
                                    ...
                                    کارشناسی کارشناسان در خصوص ادامه پخش آثارشان لحاظ خواهد شد.
                </p>
                <p>
                    <a href="http://iranfilmport.com/files/images/resource/PerformaceReport.png" target="_blank">(جهت دانلود نمونه‌ای از گزارش عملکرد کلیک کنید)</a>
                </p>
            </div>
            <hr />
            <div class="item" style="text-align: center;">
                ...
                <p>
                    <a href="http://iranfilmport.com/files/images/icons/SampleCertification.jpg" target="_blank">(جهت دانلود نمونه‌ای از این گواهینامه کلیک کنید)</a>
                </p>
            </div>
            <hr />
            <div class="item" style="text-align: center;">
                ...
                <h6>Double-Supervisor | ناظران پخش</h6>
                <p>
                ...
                <p>
                    <a href="http://iranfilmport.com/files/images/resource/System.png" target="_blank">(تصویری
                                        از محیط کاربری و سامانه اختصاصی درگاه فیلم ایران)</a>
                </p>
            </div>
            <hr />
            <div class="item" style="text-align: center;">
