                    ...
                    <div class="left-side">
                        <div class="item-holder" style="direction: rtl; text-justify: inter-word;
                            ...
                            <p>
                                ...
                                از یک پخش فیلم محسوب می شود ولی آنچیزی که حائز اهمیت است شناساسی درست فستیوال است
                            ...
                            <p>
                                «درگاه فیلم ایران» با دارا بودن کارشناسان مجرب و حرفه‌ای در این زمینه مشاوره فیلمنامه
                                و بررسی و تحلیل متن و داستان، از مرحله ایده تا فیلمنامه و بازنویسی، در خدمت فیلمسازان
                                و گروه های فیلمسازی است. از این رو؛ با سپردن ایده و فیلمنامه های کامل خود به «درگاه
                                فیلم ایران» میتوانید پیش از آنکه اقدام به ساخت فیلم و صرف هزینه‌ی میلیونی جهت ساخت
                                فیلمی کنید که خریداری در فستیوال‌های بین المللی ندارد، از آینده نسبی آن با مشاوره
