<%@ Page Title="" Language="VB" MasterPageFile="~/KingMasterSingle.master" AutoEventWireup="false" CodeFile="kingStrategy.aspx.vb" Inherits="kingStrategy" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="left-side panel">
        <div class="item-holder" style="direction: rtl; text-justify: inter-word; text-align: justify; padding: 10px;">
            <div class="alert alert-danger" role="alert" style="direction: rtl; text-align: right;">
                این مدل از پخش از سال 1397 از برنامه «درگاه فیلم ایران» خارج شده است.
                <br />
                لطفا جهت آشنایی با شیوه و مدل های پخش «درگاه فیلم ایران» به صفحه <a href="https://iranfilmport.com/%D9%BE%D8%AE%D8%B4-%D9%88-%D8%A7%D8%B1%D8%B3%D8%A7%D9%84-%D9%81%DB%8C%D9%84%D9%85" target="_blank">«چگونگی پخش و ارسال فیلم و فیلمنامه»</a> مراجعه کرده و یا 
                از طریق شماره های زیر با کارشناسان شرکت در ارتباط باشید.
            ...
            <div class="changeAcnhorTag">
            <h3>برنامه استراتژیک پخش فیلم چیست؟</h3>
            ...
            <p>
                <ul>
                    <li style="color: Black; font-size: 14px;">1.	پخش کنندگی شخصی (فیلمسازانی که خودشان اقدام به پخش و ارسال فیلمشان میکنند که از نظر درگاه فیلم ایران کاری اشتباه و معمولا به شکست ختم می شود <a target="_blank" href="http://iranfilmport.com/5">(به این مقاله رجوع شود)</a> )</li>
                    <li style="color: Black; font-size: 14px;">2.	پخش کنندگی واسطه ای (فیلمسازانی که با پخش کننده، به تعداد محدود و در زمانی مشخص، قرارداد می بندند. مانند روش دوم پخش در درگاه فیلم ایران که به روش «بسته ای» معروف است <a target="_blank" href="http://iranfilmport.com/%D9%87%D8%B2%DB%8C%D9%86%D9%87-%D9%BE%D8%AE%D8%B4-%D8%A8%DB%8C%D9%86-%D8%A7%D9%84%D9%85%D9%84%D9%84%DB%8C-%D9%81%DB%8C%D9%84%D9%85">(جهت اطلاعات بیشتر به این صفحه رجوع شود)</a> )</li>
                    <li style="color: Black; font-size: 14px;">3.	پخش کنندگی حرفه ای (فیلمسازانی که حق کامل فیلم را در زمانی مشخص با قرارداد به پخش کننده واگذار میکنند. مانند مدل سوم پخش در شرکت درگاه فیلم ایران  <a target="_blank" href="http://iranfilmport.com/%D9%87%D8%B2%DB%8C%D9%86%D9%87-%D9%BE%D8%AE%D8%B4-%D8%A8%DB%8C%D9%86-%D8%A7%D9%84%D9%85%D9%84%D9%84%DB%8C-%D9%81%DB%8C%D9%84%D9%85">(جهت اطلاعات بیشتر به این صفحه رجوع شود)</a> )</li>
                </ul>
            </p>
            ...
            <br />
            <p>روند کلی تهیه پلن و یا برنامه‌ی استراتژیک پخش فیلم:</p>
            <ul>
                <li style="color: Black; font-size: 14px;">1. ارسال فیلم از طریق شبکه‌های <a target="_blank" href="https://t.me/iranfilmportsupport">تلگرام</a> و واتس‌اپ، <a target="_blank" href="mailto:support@iranfilmport.com">ایمیل</a> و یا پستی <a target="_blank" style="color: Red;" href="http://iranfilmport.com/%D8%AA%D9%85%D8%A7%D8%B3-%D8%A8%D8%A7-%D8%AF%D8%B1%DA%AF%D8%A7%D9%87-%D9%81%DB%8C%D9%84%D9%85-%D8%A7%DB%8C%D8%B1%D8%A7%D9%86">(تماس با ما)</a></li>
                <li style="color: Black; font-size: 14px;">2. پرداخت هزینه به ازای تعداد فستیوال</li>
                <li style="color: Black; font-size: 14px;">3. تحلیل و آنالیز فیلم توسط کارشناسان درگاه فیلم ایران </li>
                <li style="color: Black; font-size: 14px;">4. تعیین استراتژی پخش</li>
                <li style="color: Black; font-size: 14px;">5. تحویل فایل وُرد برنامه به فیلمساز و یا تهیه کننده</li>
            </ul>
            <br />
            <p>تعرفه‌ی پلن استراتژیک پخش فیلم:</p>
            <table class="T">
                <tr>
                    <td>تعداد فستیوال</td>
                    <td>هزینه </td>
                ...
                <tr>
                    <td>به ازای هر فستیوال</td>
                    <td>جهت کسب اطلاعات بیشتر با کارشناسان شرکت در ارتباط باشید</td>
                </tr>
            </table>
