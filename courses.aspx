<%@ Page Title="" Language="VB" MasterPageFile="~/Master_Main.master" AutoEventWireup="false" CodeFile="courses.aspx.vb" Inherits="courses" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <style>
        ...
        .mainCourse{
            ...
            border:1px solid #f1f1f1;-moz-border-radius: 25px; -webkit-border-radius: 25px; border-radius:25px;
        }
        .detailedCourse{
            margin-top:10px;
            margin-bottom:10px;
                    ...
                    <div class="left-side">
                        <div class="item-holder" style="text-align: justify;">
                           ...
                           <div>
                            ...
                            <h4>
                            چه تفاوتی بین این دوره‌ها با دوره های دیگر آموزشگاه‌هاست؟
                            </h4>
                            <div>
...
جهت ثبت نامه در این دوره، با یکی از شماره های زیر ارتباط باشید:
                            <div style="font-weight:bold;">
                                <a href="tel:+989020763947">
                                    09020763947
                                </a>
                                <br /> <a href="tel:+09332300598">
                                09332300598</a>
                                <br />
