...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div style="padding-top: 10px;">
        <div class="warning">
            <ul>
                ...
                <li>
                    <b class="blink">توجه بسیار مهم: جهت تکمیل فرآیند، پرداخت تمام مبلغ از طریق کارت به کارت اجباری است.
                    </b>
                </li>
    ...
    <script>
        function RequestSent(amount, festivalId,userId) {
            ...
            var msg = 'لطفا مبلغ ' + '<span style="color: red;">' + amount + ' <b>(مبلغ به دلار)</b> </span>' + ' به یکی از شماره کارت های زیر واریز و رسید خود را در محل بارگذاری رسید مالی قرار دهید.';
            msg += '<br>';
            msg += '<br>';
            ...
            msg += '<br>';
            msg += '<br>';
            msg += '<span class="blink">' + 'توجه فرمائید که درخواست شما تنها زمانی تکمیل میگردد که رسید بارگذاری شود.' + '</span>';
                ...
                if (result.value) {
                    Swal.fire({
                        ...
                        if (result.value) {
                            Swal.fire({
                                title: 'توجه شماره سه!',
                                text: 'کل مبلغ پرداختی شما به همراه کمیسیون بین المللی، عینا به حساب فستیوال واریز و هیچ سود و درصدی برای «درگاه فیلم ایران» نخواهد بود. ما به تفاوت مبلغ به حساب فیلمساز عودت داده خواهد شد.',
                                icon: 'info',
                                showCancelButton: true,
                                confirmButtonColor: 'green',
                                cancelButtonColor: 'red',
                                    ...
                                    Swal.fire({
                                        ...
                                        if (result.value) {
                                            Swal.fire({
                                                ...
                                                text: 'پس از پرداخت مبلغ، به هیچ عنوان امکان لغو فرآیند به دلایل حسابداری وجود نخواهد داشت.',
                                                icon: 'info',
                                                showCancelButton: true,
                                                confirmButtonColor: 'green',
                                                cancelButtonColor: 'red',
