        ...
        <ContentTemplate>
            ...
            <div class="receipt" runat="server" visible="false" id="lblReceipt">
                <ul>
                    ...
                    <li>پاسخ های احتمالی پس از استعلام به شرح زیر است:
                <ul>
                    <li>ظاهر شدن دکمه‌ی آبی رنگ «دریافت رسید» : در این صورت روی آن کلیک کرده تا در صفحه جدید باز شده، رسید را رویت و سپس دانلود کنید.
                    </li>
                    <li>آیکن
                    ...
                    <li style="color: red;">توجه: رکوردهایی که به رنگ قرمز هستند به آن معناست که رسید آنها رویت و یا دانلود نشده اند.
                    </li>
