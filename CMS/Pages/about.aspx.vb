...
Partial Class CMS_Pages_about
    Inherits System.Web.UI.Page
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not IsPostBack Then
            Dim ds As New DLL_CMS
            txtCV.Value = ds.ShowAbout(True)
            txtCVEn.Value = ds.ShowAbout(False)
        End If
    End Sub

    Protected Sub btn_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btn.Click
        Dim ds As New DLL_CMS
        ds.UpdateAbout(txtCV.Value, True)
    End Sub
    ...
    Protected Sub btnEnUpdate_Click(sender As Object, e As System.EventArgs) Handles btnEnUpdate.Click
        Dim ds As New DLL_CMS
        ds.UpdateAbout(txtCVEn.Value, False)
    End Sub
End Class
