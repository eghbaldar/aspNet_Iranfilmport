...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        ...
        <div>
            <asp:DropDownList   CssClass="txtFa" ID="cmdFilm" runat="server" DataSourceID="SqlDataSourceFilm" DataTextField="nameFa" DataValueField="id" AutoPostBack="True">
            </asp:DropDownList>
            <asp:SqlDataSource ID="SqlDataSourceFilm" runat="server"
                ConnectionString="<%$ ConnectionStrings:iranfilmportConnectionString %>" SelectCommand="SELECT id,[nameFa]+ ' - ' + nameEn 'nameFa' FROM [tbl_PosterOfCustomer]"></asp:SqlDataSource>
        </div>
              <div  style="direction:rtl;padding:20px;font-family:Samim;font-size:20px;">لیست افتخارات این اثر:
                </div>
        <div>
            <asp:GridView ID="dgAccolades" runat="server" AutoGenerateColumns="False" CellPadding="4" DataSourceID="SqlDataSourceAccolades" ForeColor="#333333" GridLines="None" ShowHeader="False" Width="100%" DataKeyNames="id">
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="en" SortExpression="en">
                        ...
                        <ItemTemplate>
                            <asp:LinkButton ID="LinkButton1" OnClientClick="return confirm('Are you sure?x`');" runat="server" CausesValidation="False" CommandName="Delete">
                ...
                <EmptyDataTemplate>
                <div style="text-align:center;font-family:Samim;color:blue;
font-size:25px;">
            ...
            <asp:SqlDataSource ID="SqlDataSourceAccolades" runat="server" ConnectionString="<%$ ConnectionStrings:iranfilmportConnectionString %>" SelectCommand="SELECT * FROM [tbl_accolades] WHERE ([id_film] = @id_film)" DeleteCommand="delete from [tbl_accolades] where id=@id">
                <DeleteParameters>
                ...
                <div  style="direction:rtl;padding:20px;font-family:Samim;font-size:20px;">افتخار بصورت فارسی:
        ...
        <div>
            <textarea id="txtAccolade_fa" name="content" class="ckeditor" runat="server"></textarea>
                   ...
                   <div  style="direction:ltr;padding:20px;font-family:Tahoma;font-size:20px;">Accolade in English:
