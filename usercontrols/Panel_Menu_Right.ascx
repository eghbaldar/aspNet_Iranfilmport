...
<div class="holder-elements ">
        <div class="element">
            <p data-tooltip="صفحه اصلی">
                <asp:ImageButton ID="btnMnuHome" Width="40px" ImageUrl="~/files/images/icons/panel_home.png" runat="server" />
            </p>
        </div>
        <div class="element">
            <p data-tooltip="پرونده مالی">
                <asp:ImageButton ID="btnMnuMoney" Width="35px" ImageUrl="~/files/images/icons/panel_money.png"
                    runat="server" />
            </p>
        </div>
        <div class="element">
            <p data-tooltip="پیشنهاد فستیوال">
                <sapn class="button">
                <asp:ImageButton ID="btnMnuSuggestedFestival" Width="45px" ImageUrl="~/files/images/icons/suggestedfestival.png"
              runat="server" />
                 <span class="button__badge" runat="server" id="HolderLblSuggestedFestival" >
                     <asp:Label ID="lblCountFestivalSuggestion" runat="server" ></asp:Label>
                 </span>
            </sapn>
            </p>
        </div>
        ...
        <div class="element">
            <p data-tooltip="خروج">
                <asp:ImageButton ID="btnMnuExit" Width="40px" ImageUrl="~/files/images/icons/panel_exit.png"
                    runat="server" />
            </p>
        </div>
</div>
...
<div class="example-elements">
    ...
    <tr>
        ...
        <td class="tbChild">
            <span style="background-color: red; border-radius: 50%; padding: 5px; width: 20px;
