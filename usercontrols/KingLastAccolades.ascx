        ...
        <div class="row">
            ...
            <div class="col-5 text-left">
                <h6 class="font-medium pl-15">
                    <a class="text-muted font-small" href="#">مشاهده کارنامه</a>
                </h6>
            </div>
        </div>
    </div>
                    ...
                    <li class="mb-20">
                        <div class="d-flex">
                            <div class="post-thumb d-flex">
                                <a class="kingYellowForeColor" href="single.html">
                            ...
                            <div class="post-content media-body">
                                <h6 class="post-title mb-10 text-limit-2-row">
                                    <a href='<%# String.Format("/{0}", Eval("id")) %>' style="font-size:12px;" target="_blank">
                                        <%# Eval("title") %>
                                    </a>
                                </h6>
