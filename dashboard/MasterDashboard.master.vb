...
Partial Class dashboard_MasterDashboard
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            lblName.Text = String.Format("پروفایل {0}", ": <span style='color:black;font-weight:bold;'>" + DLLd.GetNameWithEmail(DLLd._Email_)).Replace("ي", "ی") + "</span>"
            ...
            With DLLd.ShowInformation(DLLd._Email_).Tables(0)
                ...
                Select Case .Rows(0)("StatusUser").ToString()
                    Case "1"
                        lblStatus.Text = "وضعیت : " + "<span style='color:green;font-weight:bold;'>تایید شده</span>"
                    Case "2"
                        lblStatus.Text = "وضعیت : " + "<span style='color:green;font-weight:bold;'>محروم شده</span>"
                    Case "3"
                        lblStatus.Text = "وضعیت : " + "<span style='color:yellow;font-weight:bold;'>نماد اعتماد</span>"
                    Case "0"
                        lblStatus.Text = "معلق : " + "<span style='color:red;font-weight:bold;'>معلق</span>"
                End Select
